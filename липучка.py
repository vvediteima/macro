...
def main():
    ...
    while True:
        ...
        clickL()
        time.sleep(40)
        rzctl.keyboard_input(31, KEYBOARD_INPUT_TYPE.KEYBOARD_DOWN)
        time.sleep(5)
        rzctl.keyboard_input(31, KEYBOARD_INPUT_TYPE.KEYBOARD_UP)
        time.sleep(1/100)
        rzctl.keyboard_input(5, KEYBOARD_INPUT_TYPE.KEYBOARD_DOWN)
        time.sleep(1/10)
        rzctl.keyboard_input(5, KEYBOARD_INPUT_TYPE.KEYBOARD_UP)
        ...
        clickR()
        time.sleep(1)
        rzctl.keyboard_input(42, KEYBOARD_INPUT_TYPE.KEYBOARD_DOWN)
        time.sleep(1/10)
        rzctl.keyboard_input(42, KEYBOARD_INPUT_TYPE.KEYBOARD_UP)
        time.sleep(1)
