...
def main():
    ...
    while True:
        for j in range(15):
            ...
            rzctl.keyboard_input(28, KEYBOARD_INPUT_TYPE.KEYBOARD_UP)
            delay(.001)
            rzctl.keyboard_input(4, KEYBOARD_INPUT_TYPE.KEYBOARD_DOWN)
            rzctl.keyboard_input(4, KEYBOARD_INPUT_TYPE.KEYBOARD_UP)
            for i in range(2):
                clickR()
            ...
            for i in range(1):
                clickR()
                rzctl.keyboard_input(32, KEYBOARD_INPUT_TYPE.KEYBOARD_DOWN)
                delay(.1)
                rzctl.keyboard_input(32, KEYBOARD_INPUT_TYPE.KEYBOARD_UP)
                delay(1.3)
            for i in range(2):
                clickR()
                rzctl.keyboard_input(30, KEYBOARD_INPUT_TYPE.KEYBOARD_DOWN)
